...
void setup(void) {
	...
	int x_star = screen_width()/2;
    int y_star = screen_height()/2;
    ...
    //      initial location which is displaced 14 units to the left and 
    //      10 units above the star.
	station = sprite_create(x_star - 14, y_star - 10, 1, 1, "9");
...
void accelerate_station_towards_star(void) {
    ...
    //      and dy by the speed. This will limit the maximum velocity of
