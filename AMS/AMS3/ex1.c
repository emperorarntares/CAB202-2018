...
void draw_rect(void) {
	...
	if (cols >= 1 && rows >= 1) {
		draw_line(l,t,l+cols-1,t,symbol);
		draw_line(l,t,l,t+rows-1,symbol);
		draw_line(l+cols-1,t+rows-1,l+cols-1,t,symbol);
		draw_line(l+cols-1,t+rows-1,l,t+rows-1,symbol);
	}
}
